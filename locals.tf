locals {
  ...
  kured_dl_url  = "https://github.com/kubereboot/kured/releases/download/${local.kured_version}/kured-${local.kured_version}-${provider::semvers::compare(local.kured_version, "1.19.0") > 0 ? "combined" : "dockerhub"}.yaml"
